...
{
	//std::cout << "Host " << pmGetHostId() << " Subtask " << pSubtaskInfo.subtaskId << std::endl << std::flush;
	if(!checkMem(pSubtaskInfo.inputMem))
		std::cout << "Data Error ... Host " << pmGetHostId() << " Subtask " << pSubtaskInfo.subtaskId << std::endl << std::flush;

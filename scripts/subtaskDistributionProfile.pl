...
$machine_num 
   Mean       @<<<<<<< @<<<<<<< @<<<<<< @<<<<<<< @<<<<<<< @<<<<<<< @<<<<<< @<<<<<<< @<<<<< (@<<<<<;@<<<<<) @<<<<< (@<<<<<;@<<<<<) @<<<<< (@<<<<<;@<<<<<) @<<<<< (@<<<<<;@<<<<<) 
$gc_0_mean $gc_1_mean $gc_2_mean $gc_3_mean $gg_0_mean $gg_1_mean $gg_2_mean $gg_3_mean $gcg_0_mean $gcg_0_mean_cpu $gcg_0_mean_gpu $gcg_1_mean $gcg_1_mean_cpu $gcg_1_mean_gpu $gcg_2_mean $gcg_2_mean_cpu $gcg_2_mean_gpu $gcg_3_mean $gcg_3_mean_cpu $gcg_3_mean_gpu
   Median     @<<<<<<< @<<<<<<< @<<<<<< @<<<<<<< @<<<<<<< @<<<<<<< @<<<<<< @<<<<<<< @<<<<< (@<<<<<;@<<<<<) @<<<<< (@<<<<<;@<<<<<) @<<<<< (@<<<<<;@<<<<<) @<<<<< (@<<<<<;@<<<<<) 
$gc_0_median $gc_1_median $gc_2_median $gc_3_median $gg_0_median $gg_1_median $gg_2_median $gg_3_median $gcg_0_median $gcg_0_median_cpu $gcg_0_median_gpu $gcg_1_median $gcg_1_median_cpu $gcg_1_median_gpu $gcg_2_median $gcg_2_median_cpu $gcg_2_median_gpu $gcg_3_median $gcg_3_median_cpu $gcg_3_median_gpu
   Std. Dev.  @<<<<<<< @<<<<<<< @<<<<<< @<<<<<<< @<<<<<<< @<<<<<<< @<<<<<< @<<<<<<< @<<<<< (@<<<<<;@<<<<<) @<<<<< (@<<<<<;@<<<<<) @<<<<< (@<<<<<;@<<<<<) @<<<<< (@<<<<<;@<<<<<)
$gc_0_sd $gc_1_sd $gc_2_sd $gc_3_sd $gg_0_sd $gg_1_sd $gg_2_sd $gg_3_sd $gcg_0_sd $gcg_0_sd_cpu $gcg_0_sd_gpu $gcg_1_sd $gcg_1_sd_cpu $gcg_1_sd_gpu $gcg_2_sd $gcg_2_sd_cpu $gcg_2_sd_gpu $gcg_3_sd $gcg_3_sd_cpu $gcg_3_sd_gpu
.

...
my($synthetic_loader_path) = "$pm_base_path/scripts/setSyntheticLoad.pl";
...
format DATA =
@<<<<<<<<<<<< @<<<<<<< @<<<<<<< @<<<<<<< @<<<<<<< @<<<<<<< @<<<<<<<
$machine_num $gc_0_subtasks $gc_1_subtasks $gg_0_subtasks $gg_1_subtasks $gcg_0_subtasks $gcg_1_subtasks
.

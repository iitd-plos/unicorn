...
pmStatus pmController::DestroyController()
{
	...
	pmScheduler::DestroyScheduler();
	pmTaskManager::DestroyTaskManager();
	MEMORY_MANAGER_IMPLEMENTATION_CLASS::DestroyMemoryManager();
	pmMachinePool::DestroyMachinePool();
	pmCommunicator::DestroyCommunicator();
	NETWORK_IMPLEMENTATION_CLASS::DestroyNetwork();
	pmStubManager::DestroyStubManager();
	pmDispatcherGPU::DestroyDispatcherGPU();
	pmLogger::DestroyLogger();
